...
- It is cross-platform, so no matter whether you have a Mac, a Windows, or a Linux machine, you should be able to have the same programming environment as everyone else. If you have a Chromebook, it isn’t so easy. It is [apparently possible to install Anaconda on a Chromebook](https://wsvincent.com/install-python3-chromebook/). If you decide to do this, I salute you, but you are on your own. Another option for Chromebook users is to use [Google Colaboratory](https://colab.research.google.com/notebooks/welcome.ipynb). Otherwise, you may just have to work with someone else, which isn’t so bad anyway.
...
1. [Brown, 1973: Excerpt from Introduction](https://drive.google.com/file/d/0B4lOOWBOiL9jeHBXV0NvMy1KeFk/view) (Right-click on the link to open)  
1. [Ingram, 1989, Chapter 3](https://drive.google.com/open?id=0B4lOOWBOiL9jVjUwSXpQamFCcGs) (Right-click on the link to open)  
...
[Notebook 1](https://ethanweed.github.io/CLA_2019/CLA_2018/Notebooks/01_Getting started with Python.html)  
[Notebook 3: IF-statements](https://ethanweed.github.io/CLA_2019/Coding/Friday Exercises/Notebooks/IF statements-for-counting-words.html)  

[Data for Notebook 2](https://raw.githubusercontent.com/ethanweed/CLA_2019/master/Coding/Friday%20Exercises/Data/Adam_mot_words_list.txt) (Right-click and choose "Download linked..")
